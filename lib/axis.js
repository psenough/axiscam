 ...
 */
var AxisCam = function(options, cb) {
    var that = this
...
AxisCam.prototype._get = function(options, cb) {
	var thisget = this.protocol.get(_.extend({}, this.url, {path: options.path}), function(res) {
